...
#if     !defined(TOS_CFG_SECURE_MMHEAP_DEFAULT_POOL_SIZE) || (TOS_CFG_SECURE_MMHEAP_DEFAULT_POOL_SIZE == 0u)
#error  "INVALID config, must define a valid TOS_CFG_SECURE_MMHEAP_DEFAULT_POOL_SIZE"
#endif

#if     !defined(TOS_CFG_NUM_SECURE_CTX) || (TOS_CFG_NUM_SECURE_CTX == 0u)
#error  "INVALID config, must define a valid TOS_CFG_NUM_SECURE_CTX"
#endif
